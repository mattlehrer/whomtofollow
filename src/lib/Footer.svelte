<footer class="mt-auto text-sm text-brand-800 opacity-75">
	<div class="mx-auto max-w-7xl overflow-hidden px-6 py-4 lg:px-8">
		...
		<div class="mt-4 flex items-baseline justify-center space-x-10 opacity-75">
			...
			>
				...
				<svg class="h-8 w-8" fill="currentColor" aria-hidden="true" viewBox="0 0 24 24">
					<path
			...
			<a
				href="https://github.com/mattlehrer/whomtofollow"
				target="_blank"
				rel="noreferrer"
				class="hover:text-brand-500"
			>
