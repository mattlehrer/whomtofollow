		...
		>
			<div class="block px-4 py-2 text-sm text-brand-900">
				...
				>
					...
					<RadioGroupOption value="most-followers" let:checked let:active>
						<span
							class:active
							class:checked
							class="relative block cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 shadow-sm focus:outline-none sm:flex sm:justify-between"
						>
							<span class="flex items-center">
								<span class="flex flex-col text-sm">
									<span id="most-followers" class="font-medium text-brand-900">Most Followers</span>
									<span id="most-followers-description" class="text-brand-800">
										<span class="block font-light sm:inline">Absolute largest accounts</span>
									</span>
								</span>
							</span>
							<span
					...
					<RadioGroupOption value="least-followers" let:checked let:active>
						<span
							class:active
							class:checked
							class="relative block cursor-pointer rounded-md border border-gray-300 bg-white px-4 py-2 shadow-sm focus:outline-none sm:flex sm:justify-between"
						>
							<span class="flex items-center">
								<span class="flex flex-col text-sm">
									<span id="least-followers" class="font-medium text-brand-900"
										>Fewest Followers</span
									>
									<span id="least-followers-description" class="text-brand-800">
										<span class="block font-light sm:inline">Absolute smallest accounts</span>
									</span>
								</span>
							</span>
							<span
