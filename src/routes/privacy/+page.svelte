<article class="prose m-4 sm:m-8">
	<h1>Privacy Policy</h1>
	<p>Last updated: January 16, 2023</p>
	<p>
	...
	<h2>Summary</h2>
	<p>
		<strong>We don't store any information about your account or the accounts your follow</strong>.
		Some fediverse servers browsers from connecting to their API. In those cases, we proxy the
		requests in order to give you the most complete public information possible for your search.
	...
	<ul>
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to Whom to Follow.
			</p>
		</li>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Whom to Follow, accessible from
				<a href="https://whomtofollow.com">https://whomtofollow.com</a>
			</p>
		</li>
		<li>
			<p>
	...
	<ul>
		...
		<li>
			<p>
				...
				data analysis, identifying usage trends, and to evaluate and improve our Service, products,
